...
\begin{Interfaz}
  ...
  \InterfazFuncion{Agentes?}{\In{as}{agentes}}{conjRapido(placa)}%
  [true]
  ...
  \InterfazFuncion{ConMismasSanciones}{\In{a}{placa}, \In{as}{agentes}}{puntero(conjRapido(placa))}%
  [estaAgente($a, as$)]
  ...
  \InterfazFuncion{ConKSanciones}{\In{k}{nat}, \Inout{as}{agentes}}{conjRapido(placa)}%
  [true]
...
\begin{Representacion}
  ...
  \begin{Estructura}{agentes}[estr]
    \begin{Tupla}[estr]
      ...
      \tupItem{claves}{conjRapido(nat)}
      \tupItem{masVig}{nat}%
      \tupItem{huboSanciones}{bool}%
      \tupItem{mismSanciones}{lista(conjRapido(nat))}%
    ...
    \begin{Tupla}[datos]
      ...
      \tupItem{capturas}{nat}%
      \tupItem{conMismSanciones}{itLista(conjRapido(nat))}%
    \end{Tupla}
...
\textbf{Algoritmos de Agentes}
  ...
  \begin{algorithm}[H]
    \text{$i$Agentes?(\In{as}{estr}) $\rightarrow$ res: conjRapido(nat)}
  ...
  \begin{algorithm}[H]
    \text{$i$ConMismasSanciones(\In{a}{nat}, \In{as}{estr}) $\rightarrow$ res: puntero(conjRapido(nat))}
  ...
  \begin{algorithm}[H]
    \text{$i$ConKSanciones(\In{k}{nat}, \Inout{as}{estr}) $\rightarrow$ res: puntero(conjRapido(nat))}
